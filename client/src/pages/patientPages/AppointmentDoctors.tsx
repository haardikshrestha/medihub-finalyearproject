...
const AppointmentDoctors = () => {
  ...
  return (
    <div>
      <div className="mb-4">
        {departmentName && <p>Showing doctors for department: {departmentName}</p>}
      </div>

      <div className="bg-gray-100 min-h-screen mt03">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {doctors.map((doctor) => (
              ...
              >
                ...
                <button
                className="bg-lime-500 text-white rounded-full px-4 py-2 hover:bg-lime-600"
